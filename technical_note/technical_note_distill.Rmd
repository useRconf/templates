...
subtitle: "using distill"
description: "[[Template](https://github.com/useRconf/templates). _Recommended total reading time: 4-5min_]"
author:
- name: Author1
  affiliation: useRconf, GitHub
  affiliation_url: https://github.com/userconf
  url: https://jravilab.github.io
  orcid_id: 0000-0001-7443-925X
- name: Author2
  affiliation: useR conference webpage
  affiliation_url: https://user2021.r-project.org/
  url: https://github.com/userconf
date: "`r Sys.Date()`"
output:
  html: distill::distill_article # using distill package
graphics: yes
...
3.  [GigaScience Technical note instructions. Oxford Academic.](https://academic.oup.com/gigascience/pages/technical_note)
4.  [ResearchGate: Writing a technical note](https://www.researchgate.net/publication/42807606_Writing_a_technical_note)
5.  [NIST Technical Note Template](https://www.overleaf.com/latex/templates/nist-technical-note-template/gjytbtqtpsmt)
